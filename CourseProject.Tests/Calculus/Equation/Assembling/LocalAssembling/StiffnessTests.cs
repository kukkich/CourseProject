    ...
    internal class StiffnessTests
    {
        ...
        public void Setup()
        {
            ...
            _assembler = new LocalMatrixAssembler(
                _materialProvider,
                xMassTemplate: new IdentityMatrix(),
                yMassTemplate: new IdentityMatrix(),

                xStiffnessTemplate: new Matrix(new double[,]
                {
                    {6, -1, -20, 27},
                    {-4, 3, 17, 41},
                    {-5, 4, 7, -17},
                ...
                yStiffnessTemplate: new Matrix(new double[,]
                {
                    {4, -1, 43, 3},
                    {34, 7, 2, 5},
                    {-8, -11, 4, -18},
